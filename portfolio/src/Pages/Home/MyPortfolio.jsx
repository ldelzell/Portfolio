        ...
        <section className="portfolio--section" id="MyPortfolio">
            <div className="portfolio--container-box">
                <div className="portfolio--container">
                    <p className="sub--title">Rescent Projects</p>
                    <h2 className="section--heading">My Portfolio</h2>
                </div>
                <div >
                    <a className="link--underline" href="https://github.com/ldelzell?tab=repositories" >
            ...
            <div className="portfolio--section--container">
                {data?.portfolio?.map((item, index) =>(
                    <div key={index} className="portfolio--section--card">
                        <div className="porfolio--section--img">
                            <img src={item.src} alt="Placeholder"  height="100%" width="100%"/>
                        </div>
